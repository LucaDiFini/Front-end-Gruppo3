...
export interface ApiHeaderHeader extends Schema.SingleType {
  ...
  attributes: {
    ...
    MenuLeft: Attribute.Component<'layout.menu-item', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    MenuRight: Attribute.Component<'layout.menu-item', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMealMeal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Head: Attribute.Component<'card.text-and-image'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Types: Attribute.Relation<'api::meal.meal', 'oneToMany', 'api::type.type'>;
    Phases: Attribute.Component<'list.assembly-phase', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    LinkBackgroundColors: Attribute.Relation<
      ...
      'api::color.color'
    >;
    TextColor: Attribute.Relation<
      'api::meal.meal',
      'oneToOne',
      'api::color.color'
    >;
    BackgroundColors: Attribute.Relation<
      'api::meal.meal',
      'oneToMany',
      'api::color.color'
    >;
    PhasesTextColor: Attribute.Relation<
      'api::meal.meal',
      'oneToOne',
      'api::color.color'
    >;
    PhasesBackgroundColor: Attribute.Relation<
      'api::meal.meal',
      'oneToOne',
      'api::color.color'
    >;
